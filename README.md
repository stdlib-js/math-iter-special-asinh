...
```javascript
import iterAsinh from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-asinh@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-asinh/tags). For example,

```javascript
import iterAsinh from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-asinh@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-asinh/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/math-iter-special-asinh/actions/workflows/test.yml?query=branch:v0.2.3
...
[deno-readme]: https://github.com/stdlib-js/math-iter-special-asinh/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-iter-special-asinh/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-iter-special-asinh/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-iter-special-asinh/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-iter-special-asinh/blob/esm/README.md
