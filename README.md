...
```javascript
import iterAsinh from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-asinh@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-asinh/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-iter-special-asinh/actions/workflows/test.yml?query=branch:v0.2.2
